...
class CreateProjetosTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Projetos", 'projetos', 'NM', 'fa-wrench', [
            ["TP", "Tipo", "String", true, "6", 2, 27, true],
            ["NM", "Nome ", "String", true, "10", 5, 100, true],
            ["VL", "Valor ", "Decimal", false, "6", 6, 30, true],
            ["ST", "Status ", "String", false, "6", 2, 11, true],
        ]);
